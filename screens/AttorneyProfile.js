...
const AttorneyProfile = ({ navigation, route }) => {
  // Get attorney details from navigation params or use defaults
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contentPadding}>
          ...
          <Text style={styles.bioText}>
            {attorney.name} is a distinguished {attorney.specialty} with over 15 years of 
            ...
            {[1, 2].map((i) => (
              <View key={i} style={styles.feedbackCard}>
                ...
                <Text style={styles.feedbackText}>
                  "{attorney.name.split(' ')[1]} provided exceptional guidance during our acquisition. Highly professional and insightful."
                </Text>
