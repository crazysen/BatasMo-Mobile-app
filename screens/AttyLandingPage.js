    ...
    <View style={styles.container}>
      ...
      <View style={styles.navbar}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('AttyMenu')}>
        ...
        <View style={styles.navRight}>
          <TouchableOpacity style={styles.navButton}><Text style={styles.bellIcon}>🔔</Text></TouchableOpacity>
      ...
      <ScrollView
        ...
        <Text style={[styles.welcomeText, isSmallScreen && styles.welcomeTextSmall]} numberOfLines={2}>Welcome back, Atty. Julianne</Text>
        <Text style={styles.subtitle}>Here's what's happening with your practice today.</Text>

        <TouchableOpacity style={styles.manageAvailabilityBtn} onPress={() => navigation.navigate('AttyAvailabilityManager')}>
        ...
        <View style={styles.statsRow}>
          <TouchableOpacity style={[styles.statCard, isSmallScreen && styles.statCardSmall]} onPress={() => navigation.navigate('AttyConsultationRequest')}>
            <View style={[styles.iconCircle, { backgroundColor: '#FEF3C7' }]}>
              <Text style={{ color: '#D97706' }}>🕒</Text>
            </View>
            <Text style={styles.statLabel}>PENDING{"\n"}CONSULTATIONS</Text>
            <Text style={[styles.statNumber, isSmallScreen && styles.statNumberSmall]}>12</Text>
          </TouchableOpacity>

          <TouchableOpacity style={[styles.statCard, isSmallScreen && styles.statCardSmall]} onPress={() => navigation.navigate('AttyMyAppointments')}>
            <View style={[styles.iconCircle, { backgroundColor: '#DBEAFE' }]}>
              <Text style={{ color: '#2563EB' }}>📅</Text>
            </View>
            <Text style={styles.statLabel}>UPCOMING{"\n"}APPOINTMENTS</Text>
            <Text style={[styles.statNumber, isSmallScreen && styles.statNumberSmall]}>5</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.sectionCard}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('AttyConsultationRequest')}><Text style={styles.viewAll}>VIEW ALL ›</Text></TouchableOpacity>
          </View>
          
          {recentConsultations.map((item) => (
            <TouchableOpacity key={item.id} style={styles.consultationRow} onPress={() => navigation.navigate('AttyConsultationRequest')}>
        ...
        <View style={styles.growthBanner}>
          <Text style={[styles.growthTitle, isSmallScreen && styles.growthTitleSmall]}>Grow your law{"\n"}practice</Text>
...
const styles = StyleSheet.create({
  ...
  navbar: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 12, backgroundColor: 'white', borderBottomWidth: 1, borderBottomColor: '#F1F5F9' },
  ...
  statusCol: { alignItems: 'flex-end', minWidth: 76 },
