...
const styles = StyleSheet.create({
  overlay: {
    flex: 1,
    backgroundColor: '#0F172A', // Deep navy background to match legal theme
  ...
  iconCircle: {
    ...
    height: 80,
    borderRadius: 40,
    backgroundColor: '#D9B041', // Signature gold color
    justifyContent: 'center',
    alignItems: 'center',
    marginBottom: 24,
  },
  ...
  amountCard: {
    backgroundColor: '#1E293B', // Dark navy card for high contrast
    width: '100%',
    paddingVertical: 24,
    borderRadius: 20,
    alignItems: 'center',
