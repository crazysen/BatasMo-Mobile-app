...
import { ChevronLeft, Info, Wallet, ChevronRight, Filter } from 'lucide-react-native';
import { LinearGradient } from 'expo-linear-gradient'; // Use 'react-native-linear-gradient' for bare workflow
